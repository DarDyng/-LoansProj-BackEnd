...
namespace LoansAppWebApi.Core.Migrations
{
    ...
    [Migration("20230408144648_EndDate Nullable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoansAppWebApi.Models.DbModels.Loans", b =>
                {
                    ...
                    b.Property<decimal>("PercentsInYear")
            ...
            modelBuilder.Entity("LoansAppWebApi.Models.DbModels.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("LoansAppWebApi.Models.DbModels.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("LoansAppWebApi.Models.DbModels.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
